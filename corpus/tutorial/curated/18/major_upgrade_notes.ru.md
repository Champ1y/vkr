---
title: "Как работать с major-версиями и release notes PostgreSQL 18"
pg_version: "18"
language: "ru"
...
---
# Как работать с major-версиями и release notes PostgreSQL 18
...
Для PostgreSQL 18 ответ должен опираться на official docs ветки `/docs/18/`. Если вопрос сравнительный, версии нужно явно разделять и использовать release notes. Supplementary-корпус может объяснять, но не должен подменять official sources.
