---
title: "Учебный маршрут по SQL в PostgreSQL 18"
pg_version: "18"
language: "ru"
...
# Учебный маршрут по SQL в PostgreSQL 18
...
Для изучения SQL в PostgreSQL 18 начни с `CREATE TABLE`, затем `INSERT`, `SELECT`, `WHERE`, `ORDER BY`, `JOIN`, `GROUP BY`, `HAVING`, `UPDATE`, `DELETE` и транзакций `BEGIN`/`COMMIT`/`ROLLBACK`.
