---
title: "Логи и медленные запросы в PostgreSQL 18"
pg_version: "18"
language: "ru"
...
# Логи и медленные запросы в PostgreSQL 18
...
Для поиска медленных запросов в PostgreSQL 18 проверь `log_min_duration_statement`, найди SQL в логах, выполни `EXPLAIN` или осторожно `EXPLAIN (ANALYZE, BUFFERS)`, затем проверь индексы и статистику.
