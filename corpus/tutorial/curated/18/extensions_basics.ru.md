---
title: "Расширения PostgreSQL 18: CREATE EXTENSION и проверка"
pg_version: "18"
language: "ru"
...
# Расширения PostgreSQL 18: CREATE EXTENSION и проверка
...
- Этот документ обучающий: точный список ограничений и совместимость версии сверяются по official docs 18.
