---
title: "pgvector и хранение эмбеддингов для RAG-проекта на PostgreSQL 18"
pg_version: "18"
language: "ru"
...
# pgvector и хранение эмбеддингов для RAG-проекта на PostgreSQL 18
...
5. Перед similarity search всегда фильтруй по version guard (`pg_version='18'`).
