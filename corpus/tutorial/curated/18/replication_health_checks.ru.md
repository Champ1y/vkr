---
title: "Проверка состояния репликации в PostgreSQL 18"
pg_version: "18"
language: "ru"
...
# Проверка состояния репликации в PostgreSQL 18
...
Чтобы проверить logical replication в PostgreSQL 18, смотри `pg_subscription` и `pg_stat_subscription` на subscriber, `pg_replication_slots` и `pg_stat_replication` на publisher, затем сделай тестовый `INSERT` на publisher и `SELECT` на subscriber.
