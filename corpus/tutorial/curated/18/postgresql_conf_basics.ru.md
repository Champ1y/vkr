---
title: "Основы postgresql.conf и ALTER SYSTEM в PostgreSQL 18"
pg_version: "18"
language: "ru"
...
# Основы postgresql.conf и ALTER SYSTEM в PostgreSQL 18
...
- Факты по допустимым диапазонам и контексту применения нужно сверять с official docs версии 18.
