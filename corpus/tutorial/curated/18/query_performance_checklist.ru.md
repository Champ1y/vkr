---
title: "Checklist диагностики медленного запроса в PostgreSQL 18"
pg_version: "18"
language: "ru"
...
# Checklist диагностики медленного запроса в PostgreSQL 18
...
- Этот checklist учебный: детальные гарантии поведения конкретных операторов сверяются по official docs версии 18.
