---
title: "Резервное копирование и восстановление в PostgreSQL 18"
pg_version: "18"
language: "ru"
...
# Резервное копирование и восстановление в PostgreSQL 18
...
Для простого backup PostgreSQL 18 используй `pg_dump -d app_db > app_db.sql`, создай пустую базу и восстанови через `psql -d restored_db -f app_db.sql`. Для гибкого восстановления используй `pg_dump -Fc` и `pg_restore`.
