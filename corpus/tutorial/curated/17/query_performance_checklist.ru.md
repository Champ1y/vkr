---
title: "Checklist диагностики медленного запроса в PostgreSQL 17"
pg_version: "17"
language: "ru"
...
official_backing:
  ...
  - "https://www.postgresql.org/docs/17/indexes-examine.html"
...
- Этот checklist учебный: детальные гарантии поведения конкретных операторов сверяются по official docs версии 17.
