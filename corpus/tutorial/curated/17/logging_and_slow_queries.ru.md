---
title: "Логи и медленные запросы в PostgreSQL 17"
pg_version: "17"
language: "ru"
...
# Логи и медленные запросы в PostgreSQL 17
...
Для поиска медленных запросов в PostgreSQL 17 проверь `log_min_duration_statement`, найди SQL в логах, выполни `EXPLAIN` или осторожно `EXPLAIN (ANALYZE, BUFFERS)`, затем проверь индексы и статистику.
