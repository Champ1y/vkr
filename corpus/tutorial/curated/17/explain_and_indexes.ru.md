---
title: "EXPLAIN и индексы в PostgreSQL 17"
pg_version: "17"
language: "ru"
...
# EXPLAIN и индексы в PostgreSQL 17
...
Для анализа запроса в PostgreSQL 17 используй `EXPLAIN`, затем при необходимости `EXPLAIN (ANALYZE, BUFFERS)`. Индекс создавай под конкретный частый фильтр, join или сортировку и проверяй план повторно.
