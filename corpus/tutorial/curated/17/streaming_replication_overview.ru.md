---
title: "Обзор streaming replication в PostgreSQL 17"
pg_version: "17"
language: "ru"
...
official_backing:
  ...
  - "https://www.postgresql.org/docs/17/different-replication-solutions.html"
...
# Обзор streaming replication в PostgreSQL 17
...
- За точными ограничениями параметров и режимов синхронности обращайся к official docs версии 17.
