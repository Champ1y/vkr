---
title: "Пошаговая настройка logical replication в PostgreSQL 17"
pg_version: "17"
language: "ru"
...
# Пошаговая настройка logical replication в PostgreSQL 17
...
Для logical replication в PostgreSQL 17 на publisher включают `wal_level=logical`, проверяют `max_replication_slots` и `max_wal_senders`, создают роль с `REPLICATION`, настраивают `pg_hba.conf`, создают `CREATE PUBLICATION`, а на subscriber — совместимую таблицу и `CREATE SUBSCRIPTION`.
