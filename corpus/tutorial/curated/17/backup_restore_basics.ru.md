---
title: "Резервное копирование и восстановление в PostgreSQL 17"
pg_version: "17"
language: "ru"
...
# Резервное копирование и восстановление в PostgreSQL 17
...
Для простого backup PostgreSQL 17 используй `pg_dump -d app_db > app_db.sql`, создай пустую базу и восстанови через `psql -d restored_db -f app_db.sql`. Для гибкого восстановления используй `pg_dump -Fc` и `pg_restore`.
