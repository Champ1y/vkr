---
title: "JSON и JSONB в PostgreSQL 17"
pg_version: "17"
language: "ru"
...
В PostgreSQL 17 для большинства практических задач выбирают `jsonb`, потому что он удобен для операторов, поиска и GIN-индексов. Важные поля и связи лучше хранить обычными колонками, а `jsonb` использовать для гибких дополнительных атрибутов.
