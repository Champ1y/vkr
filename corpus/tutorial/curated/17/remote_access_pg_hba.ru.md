---
title: "Удалённый доступ, listen_addresses и pg_hba.conf в PostgreSQL 17"
pg_version: "17"
language: "ru"
...
# Удалённый доступ, listen_addresses и pg_hba.conf в PostgreSQL 17
...
Для удалённого доступа в PostgreSQL 17 проверь `listen_addresses`, доступность порта, добавь точное правило в `pg_hba.conf`, выполни `SELECT pg_reload_conf()` и подключись через `psql -h <host> -U <role> -d <database>`.
