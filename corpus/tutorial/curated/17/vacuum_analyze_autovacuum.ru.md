---
title: "VACUUM, ANALYZE и autovacuum в PostgreSQL 17"
pg_version: "17"
language: "ru"
...
official_backing:
  ...
  - "https://www.postgresql.org/docs/17/runtime-config-autovacuum.html"
...
# VACUUM, ANALYZE и autovacuum в PostgreSQL 17
...
В PostgreSQL 17 `VACUUM` очищает dead tuples, `ANALYZE` обновляет статистику, а autovacuum делает это автоматически. Не отключай autovacuum без серьёзной причины и не используй `VACUUM FULL` как обычную регулярную операцию.
