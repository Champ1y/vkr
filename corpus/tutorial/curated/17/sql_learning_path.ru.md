---
title: "Учебный маршрут по SQL в PostgreSQL 17"
pg_version: "17"
language: "ru"
...
tags:
  ...
  - "transactions"
official_backing:
  - "https://www.postgresql.org/docs/17/tutorial-sql.html"
  - "https://www.postgresql.org/docs/17/tutorial-table.html"
  - "https://www.postgresql.org/docs/17/tutorial-select.html"
  - "https://www.postgresql.org/docs/17/tutorial-join.html"
...
# Учебный маршрут по SQL в PostgreSQL 17
...
Для изучения SQL в PostgreSQL 17 начни с `CREATE TABLE`, затем `INSERT`, `SELECT`, `WHERE`, `ORDER BY`, `JOIN`, `GROUP BY`, `HAVING`, `UPDATE`, `DELETE` и транзакций `BEGIN`/`COMMIT`/`ROLLBACK`.
