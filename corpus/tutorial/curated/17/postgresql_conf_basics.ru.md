---
title: "Основы postgresql.conf и ALTER SYSTEM в PostgreSQL 17"
pg_version: "17"
language: "ru"
...
official_backing:
  ...
  - "https://www.postgresql.org/docs/17/view-pg-settings.html"
  - "https://www.postgresql.org/docs/17/sql-altersystem.html"
external_reference:
...
# Основы postgresql.conf и ALTER SYSTEM в PostgreSQL 17
...
- Факты по допустимым диапазонам и контексту применения нужно сверять с official docs версии 17.
