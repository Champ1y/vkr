---
title: "VACUUM, ANALYZE и autovacuum в PostgreSQL 16"
pg_version: "16"
language: "ru"
...
# VACUUM, ANALYZE и autovacuum в PostgreSQL 16
...
В PostgreSQL 16 `VACUUM` очищает dead tuples, `ANALYZE` обновляет статистику, а autovacuum делает это автоматически. Не отключай autovacuum без серьёзной причины и не используй `VACUUM FULL` как обычную регулярную операцию.
