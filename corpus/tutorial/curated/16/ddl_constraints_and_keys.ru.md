---
title: "Таблицы, типы данных, ключи и ограничения в PostgreSQL 16"
pg_version: "16"
language: "ru"
...
official_backing:
  ...
  - "https://www.postgresql.org/docs/16/ddl-basics.html"
...
# Таблицы, типы данных, ключи и ограничения в PostgreSQL 16
...
- Этот материал обучающий: нюансы каждого типа/ограничения уточняй в official docs версии 16.
