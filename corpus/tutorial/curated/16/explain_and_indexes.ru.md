---
title: "EXPLAIN и индексы в PostgreSQL 16"
pg_version: "16"
language: "ru"
...
# EXPLAIN и индексы в PostgreSQL 16
...
Для анализа запроса в PostgreSQL 16 используй `EXPLAIN`, затем при необходимости `EXPLAIN (ANALYZE, BUFFERS)`. Индекс создавай под конкретный частый фильтр, join или сортировку и проверяй план повторно.
