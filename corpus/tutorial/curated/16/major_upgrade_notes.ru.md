---
title: "Как работать с major-версиями и release notes PostgreSQL 16"
pg_version: "16"
language: "ru"
...
---
# Как работать с major-версиями и release notes PostgreSQL 16
...
Для PostgreSQL 16 ответ должен опираться на official docs ветки `/docs/16/`. Если вопрос сравнительный, версии нужно явно разделять и использовать release notes. Supplementary-корпус может объяснять, но не должен подменять official sources.
