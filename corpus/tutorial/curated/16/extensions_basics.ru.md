---
title: "Расширения PostgreSQL 16: CREATE EXTENSION и проверка"
pg_version: "16"
language: "ru"
...
official_backing:
  ...
  - "https://www.postgresql.org/docs/16/view-pg-available-extension-versions.html"
external_reference:
  []
...
# Расширения PostgreSQL 16: CREATE EXTENSION и проверка
...
- Этот документ обучающий: точный список ограничений и совместимость версии сверяются по official docs 16.
