---
title: "Удалённый доступ, listen_addresses и pg_hba.conf в PostgreSQL 16"
pg_version: "16"
language: "ru"
...
tags:
  ...
  - "remote access"
official_backing:
  - "https://www.postgresql.org/docs/16/client-authentication.html"
...
# Удалённый доступ, listen_addresses и pg_hba.conf в PostgreSQL 16
...
Для удалённого доступа в PostgreSQL 16 проверь `listen_addresses`, доступность порта, добавь точное правило в `pg_hba.conf`, выполни `SELECT pg_reload_conf()` и подключись через `psql -h <host> -U <role> -d <database>`.
