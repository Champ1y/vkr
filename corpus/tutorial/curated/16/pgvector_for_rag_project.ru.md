---
title: "pgvector и хранение эмбеддингов для RAG-проекта на PostgreSQL 16"
pg_version: "16"
language: "ru"
...
# pgvector и хранение эмбеддингов для RAG-проекта на PostgreSQL 16
...
5. Перед similarity search всегда фильтруй по version guard (`pg_version='16'`).
