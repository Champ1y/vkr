---
title: "Обзор streaming replication в PostgreSQL 16"
pg_version: "16"
language: "ru"
...
# Обзор streaming replication в PostgreSQL 16
...
- За точными ограничениями параметров и режимов синхронности обращайся к official docs версии 16.
