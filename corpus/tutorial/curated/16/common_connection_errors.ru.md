---
title: "Типовые ошибки подключения и прав в PostgreSQL 16"
pg_version: "16"
language: "ru"
...
official_backing:
  ...
  - "https://www.postgresql.org/docs/16/database-roles.html"
...
# Типовые ошибки подключения и прав в PostgreSQL 16
