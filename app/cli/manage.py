    ...
    *,
    ...
    with SessionLocal() as db:
        pipeline = IndexingPipeline(
            ...
            commit_every_docs=commit_every_docs,
...
def parse_args() -> argparse.Namespace:
    ...
    reindex_cmd.add_argument(
        ...
        type=int,
        default=None,
        help="Embedding batch size override (default: EMBEDDING_BATCH_SIZE).",
    )
    reindex_cmd.add_argument(
        "--commit-every-docs",
        type=int,
        default=25,
        help="How many prepared documents to accumulate before DB save/commit.",
    )
    reindex_cmd.add_argument(
        "--progress-every",
        type=int,
        default=10,
        help="Progress logging interval for docs and embedding batches.",
    )
