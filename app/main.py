...
async def lifespan(_app: FastAPI):
    ...
    settings.supplementary_path.mkdir(parents=True, exist_ok=True)
    seed_versions()
    logger.info(
        "Generation configuration: groq_base_url=%s groq_model=%s embedding_provider=%s ollama_base_url=%s",
